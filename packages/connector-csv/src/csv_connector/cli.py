"""CLI entry point: holocron-csv scan PATH ..."""
...
from csv_connector.client import HolocronClient
from csv_connector.mapping import map_scan_to_holocron

app = typer.Typer(help="Holocron CSV connector — scan .csv/.tsv files and push to the Holocron API.")
...
def scan(
    ...
    """Scan a CSV file and push its assets/actors/relations to the Holocron API."""
