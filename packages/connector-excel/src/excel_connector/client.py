...
from excel_connector import DISCOVERED_BY
...
class HolocronClient:
        ...
        if existing.status_code == 200:
            body = self._client.put(
                ...
                json={
                    ...
                    # Re-stamping discovered_by on every update keeps provenance fresh
    ...
    def create_relation_if_missing(self, payload: RelationPayload) -> tuple[bool, dict[str, Any] | None]:
        ...
        # Tolerate 404 on either endpoint of a relation if a reference is missing
